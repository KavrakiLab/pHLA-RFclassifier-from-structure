...
# run netMHCpan
call(["~/Downloads/netMHCpan-4.0/netMHCpan -p temp.txt -a " + hla_name_netMHC + " > temp_out.txt"], shell=True)
# extract predicted labels
call(["grep \"PEPLIST \" temp_out.txt | awk '{ print $12 }' > out1.txt"], shell=True)
...
call(["~/Downloads/netMHCpan-4.0/netMHCpan -p temp.txt -a " + hla_name_netMHC + " > temp_out.txt"], shell=True)
# extract predicted labels
call(["grep \"PEPLIST \" temp_out.txt | awk '{ print $12 }' > out0.txt"], shell=True)
